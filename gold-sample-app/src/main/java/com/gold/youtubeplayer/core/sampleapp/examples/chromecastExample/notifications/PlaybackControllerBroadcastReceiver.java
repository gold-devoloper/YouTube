package com.gold.youtubeplayer.core.sampleapp.examples.chromecastExample.notifications;
...
public class PlaybackControllerBroadcastReceiver extends BroadcastReceiver implements ChromecastConnectionListener {
    ...
    public static final String TOGGLE_PLAYBACK = "com.pierfrancescosoffritti.youtubeplayer.chromecast.example.TOGGLE_PLAYBACK";
    public static final String STOP_CAST_SESSION = "com.pierfrancescosoffritti.youtubeplayer.chromecast.example.STOP_CAST_SESSION";
