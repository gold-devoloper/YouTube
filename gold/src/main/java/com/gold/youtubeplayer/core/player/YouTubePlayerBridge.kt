package com.gold.youtubeplayer.core.player
...
class YouTubePlayerBridge(private val youTubePlayerOwner: YouTubePlayerBridgeCallbacks) {
    ...
    @JavascriptInterface
    fun sendHideMoreVideosPopup() =
        mainThreadHandler.post { youTubePlayerOwner.hideMoreVideosPopup()
        }
    @JavascriptInterface
    fun sendHideVideoTitle() =
        mainThreadHandler.post { youTubePlayerOwner.hideVideoTitle()
        }
    @JavascriptInterface
    fun sendHideCaption() =
        mainThreadHandler.post { youTubePlayerOwner.hideCaption()
        }
    @JavascriptInterface
    fun sendReady() {
